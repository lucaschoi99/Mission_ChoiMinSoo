package com.bell.ringMyBell.likeInfo.controller;

import com.bell.ringMyBell.boundedContext.likeInfo.controller.LikeInfoController;
...
@Transactional
@ActiveProfiles("test")
public class LikeInfoControllerTests {
    ...
    void t001() throws Exception {
        ...
        ResultActions resultActions = mvc
                .perform(get("/likeInfo/add"))
                .andDo(print());

        // THEN
        resultActions
                .andExpect(handler().handlerType(LikeInfoController.class))
    ...
    @Test
    @DisplayName("등록 폼 처리(user2가 abcd에게 호감표시(외모), abcd는 아직 가입하지 않은상태)")
    @WithUserDetails("user2")
