package com.bell.ringMyBell.instaMember.controller;


import com.bell.ringMyBell.boundedContext.instaMember.controller.InstaMemberController;
...
public class InstaMemberControllerTests {
    ...
    void t003() throws Exception {
        ...
        resultActions
                ...
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrlPattern("/likeInfo/add**"));
